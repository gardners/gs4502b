...
#define I_LDA DO_LOAD|ALU_NOP|ALUSRC_M|ALUDST_A|UPDATE_NZ
#define I_LDX DO_LOAD|ALU_NOP|ALUSRC_M|ALUDST_X|UPDATE_NZ
#define I_LAX DO_LOAD|ALU_NOP|ALUSRC_M|ALUDST_A|ALUDST_X|UPDATE_NZ
#define I_LDY DO_LOAD|ALU_NOP|ALUSRC_M|ALUDST_Y|UPDATE_NZ
#define I_LDZ DO_LOAD|ALU_NOP|ALUSRC_M|ALUDST_Z|UPDATE_NZ
