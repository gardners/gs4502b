...
#define I_LDX DO_LOAD|ALU_NOP|ALUDST_X|UPDATE_NZ
#define I_LAX DO_LOAD|ALU_NOP|ALUDST_A|ALUDST_X|UPDATE_NZ
#define I_LDY DO_LOAD|ALU_NOP|ALUDST_Y|UPDATE_NZ
#define I_LDZ DO_LOAD|ALU_NOP|ALUDST_Z|UPDATE_NZ
#define I_STA DO_STORE|ALU_NOP|ALUSRC_A|UPDATE_NZ
#define I_STX DO_STORE|ALU_NOP|ALUSRC_X|UPDATE_NZ
#define I_SAX DO_STORE|ALU_NOP|ALUSRC_A|ALUSRC_X|UPDATE_NZ
#define I_STY DO_STORE|ALU_NOP|ALUSRC_Y|UPDATE_NZ
#define I_STZ DO_STORE|ALU_NOP|ALUSRC_Z|UPDATE_NZ
...
#define I_CMP ALU_SBC|ALUSRC_A|UPDATE_NZ|UPDATE_C|UPDATE_V
#define I_CPX ALU_SBC|ALUSRC_X|UPDATE_NZ|UPDATE_C|UPDATE_V
#define I_CPY ALU_SBC|ALUSRC_Y|UPDATE_NZ|UPDATE_C|UPDATE_V
#define I_CPZ ALU_SBC|ALUSRC_Z|UPDATE_NZ|UPDATE_C|UPDATE_V
...
#define I_PHA DO_PUSH|ALUSRC_A|ALU_NOP
#define I_PHP DO_PUSH|ALUSRC_P|ALU_NOP
#define I_PHX DO_PUSH|ALUSRC_X|ALU_NOP
#define I_PHY DO_PUSH|ALUSRC_Y|ALU_NOP
#define I_PHZ DO_PUSH|ALUSRC_Z|ALU_NOP
...
#define I_TAB ALUSRC_A|ALUDST_B|ALU_NOP
#define I_TAX ALUSRC_A|ALUDST_X|ALU_NOP|UPDATE_NZ
#define I_TAY ALUSRC_A|ALUDST_Y|ALU_NOP|UPDATE_NZ
#define I_TAZ ALUSRC_A|ALUDST_Z|ALU_NOP|UPDATE_NZ
#define I_TBA ALUSRC_B|ALUDST_A|ALU_NOP|UPDATE_NZ
#define I_TXA ALUSRC_X|ALUDST_A|ALU_NOP|UPDATE_NZ
#define I_TYA ALUSRC_Y|ALUDST_A|ALU_NOP|UPDATE_NZ
#define I_TZA ALUSRC_Z|ALUDST_A|ALU_NOP|UPDATE_NZ

#define I_TYS ALUSRC_Y|ALUDST_SPH|ALU_NOP
#define I_TSY ALUSRC_SPH|ALUDST_Y|UPDATE_NZ|ALU_NOP
#define I_TXS ALUSRC_X|ALUDST_SPL|ALU_NOP
#define I_TSX ALUSRC_SPL|ALUDST_X|UPDATE_NZ|ALU_NOP
...
int main()
{
  ...
  fprintf(f,
          "  end record;\n"
	  "\n"
	  "  function instruction_equations(opcode : std_logic_vector(8 downto 0)) return addressing_mode;\n"
	  "\n"
	  "end package;\n"
	  "\n"
	  "package body instruction_equations is\n"
	  "  function instruction_equations(opcode : std_logic_vector(8 downto 0)) return addressing_mode is\n"
