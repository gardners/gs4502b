...
int main()
{
  ...
  fprintf(f,
          "  end record;\n"
	  "\n"
	  "  function get_addressing_modes(opcode : std_logic_vector(8 downto 0)) return addressing_mode;\n"
	  "\n"
	  "end package;\n"
	  "\n"
	  "package body addressing_modes is\n"
	  "  function get_addressing_modes(opcode : std_logic_vector(8 downto 0)) return addressing_mode is\n"
