...
xst -ifn xst.scr
move dotclock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dotclock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dotclock_exdes.ucf dotclock_exdes

echo 'Running map'
map -timing -pr b dotclock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dotclock_exdes -w routed.ncd routed.vhd
cd ..
